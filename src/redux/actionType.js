...
export const SELECTED_VIDEO_SUCCESS = 'HOME_VIDEOS_SUCCESS'
export const SELECTED_VIDEO_FAIL = 'HOME_VIDEOS_FAIL'
export const SELECTED_VIDEO_REQUEST = 'HOME_VIDEOS_REQUEST' 
